...
function ExplorePage() {
  return (
    <section className="mx-auto grid w-full max-w-3xl gap-6 rounded-3xl border border-line bg-white p-6 shadow-[0_24px_60px_-40px_rgba(9,15,38,0.45)] sm:p-8">
      <header>
      ...
      <p className="text-ink-soft">
        ...
        education here: <a className="text-accent underline" href="https://react.dev/" target="_blank" rel="noopener noreferrer">React Documentation</a>.
      </p>
